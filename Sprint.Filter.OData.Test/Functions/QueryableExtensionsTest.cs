...
namespace Sprint.Filter.OData.Test.Functions
{
    ...
    public class QueryableExtensionsTest
    {
        ...
        public void First()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.First().Id == 15),
                Filter.Deserialize<Customer>("Customers/First()/Id eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.First(c=>c.Name=="test").Id == 15),
        ...
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.FirstOrDefault().Id == 15),
                Filter.Deserialize<Customer>("Customers/FirstOrDefault()/Id eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.FirstOrDefault(c => c.Name == "test").Id == 15),
        ...
        public void Last()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Last().Id == 15),
                Filter.Deserialize<Customer>("Customers/Last()/Id eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Last(c => c.Name == "test").Id == 15),
        ...
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.LastOrDefault().Id == 15),
                Filter.Deserialize<Customer>("Customers/LastOrDefault()/Id eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.LastOrDefault(c => c.Name == "test").Id == 15),
        ...
        public void Single()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Single().Id == 15),
                Filter.Deserialize<Customer>("Customers/Single()/Id eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Single(c => c.Name == "test").Id == 15),
        ...
        public void Count()
        {
            ...
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Count(c => c.Name == "test") == 15),
        ...
        public void Min()
        {                   
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Min() == 15),
               Filter.Deserialize<Customer>("Numbers/Min() eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Min(x => x.Id) == 15),
...
// ReSharper disable once CompareOfFloatsByEqualityOperator
        ...
        public void GroupBy()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.GroupBy(x => x.Id).Count() == 15), 
        ...
        {
            // ReSharper disable once ReplaceWithSingleCallToCount
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Take(5).Count() == 5),
                Filter.Deserialize<Customer>("Customers/Take(5)/Count() eq 5")));

            // ReSharper disable once ReplaceWithSingleCallToCount
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Take(5).Count() == 5),
        ...
        {
            // ReSharper disable once ReplaceWithSingleCallToCount
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.Skip(5).Count() == 5),
                Filter.Deserialize<Customer>("Customers/Skip(5)/Count() eq 5")));

            // ReSharper disable once ReplaceWithSingleCallToCount
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Skip(5).Count() == 5),
        ...
        public void OrderBy()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.OrderBy(x => x.Id).Select(x=>x.Id).First() == 15),
               Filter.Deserialize<Customer>("Customers/OrderBy(x: x/Id)/Select(x: x/Id)/First() eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Distinct().OrderBy(x=>x).First() == 15),
        ...
        public void ThenBy()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.OrderBy(x => x.Id).ThenBy(x=>x.Name).Select(x => x.Id).First() == 15),
               Filter.Deserialize<Customer>("Customers/OrderBy(x: x/Id)/ThenBy(x: x/Name)/Select(x: x/Id)/First() eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Distinct().OrderBy(x => x).ThenBy(x => x).First() == 15),
        ...
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Customers.OrderByDescending(x => x.Id).Select(x => x.Id).First() == 15),
               Filter.Deserialize<Customer>("Customers/OrderByDescending(x: x/Id)/Select(x: x/Id)/First() eq 15")));

            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Expr<Customer, bool>(t => t.Numbers.Distinct().OrderByDescending(x => x).First() == 15),
