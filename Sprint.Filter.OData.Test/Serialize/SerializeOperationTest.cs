...
namespace Sprint.Filter.OData.Test.Serialize
{
    ...
    public class SerializeOperationTest
    {
        ...
        {
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => -t.Id > 0)), "-Id gt 0");

            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => -t.FreightDoubleNullable > 0)), "-FreightDoubleNullable gt 0");            
        }

        [TestMethod]
        public void LogicalNegation()
        {
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => !(t.FreightDoubleNullable > t.FreightDouble))), "not (FreightDoubleNullable gt FreightDouble)");

            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => !t.Name.EndsWith("milk"))), "not endswith(Name, 'milk')");
        }
        ...
        {                        
            ...
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.FreightDoubleNullable == t.FreightDouble)), "FreightDoubleNullable eq FreightDouble");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Sbyte == 15)), "Sbyte eq 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Char == 15)), "Char eq 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableSbyte == 15)), "NullableSbyte eq 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableChar == 15)), "NullableChar eq 15");
            // ReSharper disable once ConditionIsAlwaysTrueOrFalse
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Id == null)), "Id eq null");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => null > t.Id)), "null gt Id");            
        ...
        {
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => null != t.FreightDecimalNullable)), "null ne FreightDecimalNullable");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Name != t.LastName)), "Name ne LastName");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Id != 15)), "Id ne 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.FreightDoubleNullable != t.FreightDouble)), "FreightDoubleNullable ne FreightDouble");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Sbyte != 15)), "Sbyte ne 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Char != 15)), "Char ne 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableSbyte != 15)), "NullableSbyte ne 15");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableChar != 15)), "NullableChar ne 15");
            // ReSharper disable once ConditionIsAlwaysTrueOrFalse
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Id != null)), "Id ne null");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.FreightDecimalNullable != null)), "FreightDecimalNullable ne null");
        ...
        {
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableSbyte / t.NullableSbyte > 10)), "NullableSbyte div NullableSbyte gt 10");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Sbyte / t.Sbyte > 10)), "Sbyte div Sbyte gt 10");
            // ReSharper disable once ConditionIsAlwaysTrueOrFalse
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.Sbyte / t.Sbyte == null)), "Sbyte div Sbyte eq null");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableSbyte / t.NullableSbyte == null)), "NullableSbyte div NullableSbyte eq null");
            Assert.AreEqual(Filter.Serialize(Linq.Expr<Customer, bool>(t => t.NullableSbyte / t.Sbyte > 10)), "NullableSbyte div Sbyte gt 10");
        }
    }
}
