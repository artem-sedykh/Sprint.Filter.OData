...
// ReSharper disable once SpecifyACultureInStringConversionExplicitly
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Linq.Expr<Customer, bool>(t => t.Id.ToString() == "15"),
        ...
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Linq.Expr<Customer, bool>(t => t.Id.Equals(15)),
        ...
        public void GroupBy()
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Linq.Expr<Customer, bool>(t => t.Customers.GroupBy(x=>x.Name).Count()==1),
        ...
        {
            Assert.IsTrue(ExpressionEqualityComparer.Equals(Linq.Linq.Expr<Customer, bool>(t => t.CustomName1 == 1 || t.CustomName2==2 || t.CustomName3==3),
